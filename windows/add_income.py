...
class AddIncomeWindow(tk.Toplevel):
    ...
    def __init__(self, parent, db):
        ...
        self.categories = []  # Cached (id, name, type) rows; needed to map a source name back to its id on save.
    ...
    def load_categories(self):
        ...
        # Keep only Income-type categories (index 2) since this is the income form.
        ...
        # Preselect the first source, or show a placeholder when none exist yet.
        if names:
    ...
    def on_save(self):
        ...
        try:
            ...
            # Validate first; type is hard-coded to "Income" because this is the income form.
            ...
            # Resolve the validated source name (clean[2]) to its DB id for the foreign key.
            category_id = None
